...
export function Terms() {
  return (
    <motion.div
      ...
      className="min-h-screen bg-afterhours-black pt-28 pb-20 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-4xl mx-auto">
        {/* Back Link */}
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-white/50 hover:text-afterhours-cyan transition-colors mb-8"
        >
          <ArrowLeft size={14} className="text-afterhours-cyan" />
          Back to Home
        </Link>
        ...
        <div className="border-b border-white/10 pb-8 mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-afterhours-cyan/10 border border-afterhours-cyan/25 p-2 rounded-xl text-afterhours-cyan">
              <FileText size={20} />
            </div>
            <span className="text-xs font-mono uppercase tracking-widest text-[#7ED9D9] font-bold">
              Legal Agreement
            </span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-extrabold uppercase italic bg-clip-text text-transparent bg-linear-to-r from-white via-white to-white/60 tracking-tight font-display">
            Terms and Conditions
          </h1>
          <p className="mt-2 text-xs font-mono uppercase tracking-wider text-white/40">
            Last updated: May 2026 • Please read carefully before renting
          </p>
        </div>

        {/* Legal Text Content */}
        <div className="space-y-8 text-white/80 leading-relaxed font-sans text-sm">
          <section id="section-1" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">01.</span>
              Rental Contract
            </h2>
            <p>
          ...
          <section id="section-2" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">02.</span>
              Tenure of Contract
            </h2>
            <div className="space-y-3">
              ...
              <div className="border-l-2 border-afterhours-cyan/20 pl-4 space-y-2">
                <p>
              ...
              <p className="inline-flex gap-2 items-center text-xs font-mono bg-amber-500/10 border border-amber-500/20 text-amber-400 p-3 rounded-xl mt-2 w-full">
                <span>⚠️</span>
                <span>
          ...
          <section id="section-3" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">03.</span>
              Payment Policy
            </h2>
            <div className="space-y-3">
              <p>
          ...
          <section id="section-4" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">04.</span>
              Delivery Policy
            </h2>
            <div className="space-y-3">
              <p>
          ...
          <section id="section-5" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">05.</span>
          ...
          <section id="section-6" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">06.</span>
          ...
          <section id="section-7" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">07.</span>
          ...
          <section id="section-8" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">08.</span>
          ...
          <section id="section-9" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">09.</span>
              Data Privacy Policy
            </h2>
            <p>
          ...
          <section id="section-10" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">10.</span>
          ...
          <section id="section-11" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">11.</span>
          ...
          <section id="section-12" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">12.</span>
          ...
          <section id="section-13" className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
            <h2 className="text-lg font-black uppercase text-afterhours-cyan font-display mb-3 flex items-center gap-2">
              <span className="text-xs font-mono text-afterhours-cyan/50">13.</span>
        ...
        {/* Footer info box */}
        <div className="mt-12 p-6 bg-linear-to-r from-afterhours-cyan/10 to-afterhours-purple/10 border border-white/10 rounded-2xl flex items-start gap-4">
          <Shield className="text-afterhours-cyan shrink-0 mt-0.5" size={20} />
          <div>
